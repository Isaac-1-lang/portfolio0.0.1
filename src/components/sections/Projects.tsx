  ...
  const projects = [
    {
      ...
      description: 'Developed an intelligent chatbot using NLP and machine learning for automated customer support.',
    ...
    },
    {
      ...
      description: 'Suite of encryption and decryption tools implementing modern cryptographic algorithms.',
    ...
    },
    {
      ...
      description: 'IoT system for home automation using Arduino and mobile app control.',
